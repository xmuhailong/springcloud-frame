package com.zzl.core.sms.utils;


import com.alibaba.fastjson.JSON;
import com.zzl.core.base.constants.Constant;
import com.zzl.core.sms.domain.SmsSendRequest;
import com.zzl.core.sms.domain.SmsSendResponse;
...
public class SmsSendUtil {
     ...
     */
    private static final String ACCOUNT = "N0130064";

    /**
     * 用户平台API密码(非登录密码)
     */
    private static final String PASSWORD = "F5EtSrxZbG6caf";

    private static final String REPORT = "true";

    private static final String SIGNATURE ="【智云服】";
     ...
     * @return
     */
    public static SmsSendResponse sendMessage(String receiveUser, String message) throws Exception {
     ...
     * @throws
     */
    private static String sendSmsByPost(String path, String postContent) throws Exception {
        ...
        try {
            ...
            if (httpRspCode == HttpURLConnection.HTTP_OK) {
                ...
                throw new RuntimeException("短信下发失败");
            }
        } catch (Exception e) {
            throw new RuntimeException("短信下发失败");
        }
